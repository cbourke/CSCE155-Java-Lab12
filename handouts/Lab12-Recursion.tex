...
\begin{enumerate}
  \item Complete the \mintinline{java}{isPalindrome} function in the 
	\mintinline{text}{Palindrome.java} source file as specified above.
  \item Compile and test your program from the command line.  
	...
	\mintinline{text}{"rats live on no evil star"}
  \item Answer the questions on your worksheet
\end{enumerate}
	
\subsection{A Recursive Function}

We have provided you a program, \mintinline{text}{RecursiveFunction.java} 
...
Write a \mintinline{java}{main} method that reads in an integer $n$ and 
outputs $J_n$.  Place your code in a source file named 
\mintinline{text}{Jacobsthal.java}.
...
\begin{enumerate}
  \item Hand in your completed files:
    \begin{itemize}
    \item \mintinline{text}{Palindrome.java}
    \item \mintinline{text}{Jacobsthal.java}
    \item \mintinline{text}{Suffix.java}
